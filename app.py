...
# ── Load env (works locally + HuggingFace + Streamlit Cloud) ────
try:
    from dotenv import load_dotenv
    load_dotenv()
except:
    pass  # dotenv not needed on cloud

# get keys from environment (works everywhere)
GROQ_API_KEY = os.environ.get("GROQ_API_KEY", "")
TAVILY_API_KEY = os.environ.get("TAVILY_API_KEY", "")
SEMANTIC_SCHOLAR_API_KEY = os.environ.get("SEMANTIC_SCHOLAR_API_KEY", "")
USER_ID = os.environ.get("USER_ID", "research_agent_user")
